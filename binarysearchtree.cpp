...
// <------  INITIALIZATION OF THE STACK AND IT'S BASIC OPERATION  ---->
struct Stack{
	int size;
	int top;
	NODE* *arr;
...
NODE* del(NODE *p, int data){
    ...
    if(p == NULL){
        ...
        if(p->rchild && p->lchild){ /* Here we will replace with minimum element in the rchild sub tree */
...
int main(){
    ...
    case 2: printf("\nEnter the element to delete: ");
        ...
        root=del(root, data);
        break;
    case 3: printf("Number of leaves : %d\n",leaves(root));
